...
function getSteps() {
    return [ 'Select a BioInformatic Pairwaise Alignment', 'Enter your DNA sequences', 'Enter your variables', 'Click enter to results'];
}
...
function getStepContent(step: number) {
    switch (step) {
        ...
        case 1:
            return `There are two inputs.You need to enter your two DNA sequences. 
